...
public:
	...
	void Draw(const BMPImage& image, const Sprite& sprite, Vec2D& pos, const Color& overlayColor = Color::White(), bool rotate = false, float angle = 0);
	void Draw(const SpriteSheet& spriteSheet, const std::string& spriteName, Vec2D& pos, const Color& overlayColor = Color::White(), bool rotate = false, float angle = 0);
