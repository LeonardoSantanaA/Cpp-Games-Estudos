...
ScreenBuffer::ScreenBuffer(ScreenBuffer&& otherScreenBuffer) noexcept :mSurface(nullptr) {
...
ScreenBuffer& ScreenBuffer::operator=(ScreenBuffer&& otherScreenBuffer) noexcept{
